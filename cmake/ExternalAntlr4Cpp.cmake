...
macro(antlr4cpp_process_grammar
  ...
  add_custom_target("antlr4cpp_generation_${antlr4cpp_project_namespace}"
    ...
    COMMAND
    "${Java_JAVA_EXECUTABLE}" -jar "${ANTLR4CPP_JAR_LOCATION}" -Werror -Dlanguage=Cpp -o "${ANTLR4CPP_GENERATED_SRC_DIR}/${antlr4cpp_project_namespace}" -package ${antlr4cpp_project_namespace} "${antlr4cpp_grammar}"
