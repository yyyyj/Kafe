...
KafeParser::BlockContext* KafeParser::block() {
  ...
  try {
    ...
    while ((((_la & ~ 0x3fULL) == 0) &&
      ...
      | (1ULL << KafeParser::T__13))) != 0) || _la == KafeParser::NAME) {
      setState(53);
      stat();
      setState(58);
      _errHandler->sync(this);
...
KafeParser::FunctioncallContext* KafeParser::functioncall() {
  ...
  try {
    ...
    while (((((_la - 24) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 24)) & ((1ULL << (KafeParser::T__23 - 24))
      | (1ULL << (KafeParser::T__24 - 24))
      | (1ULL << (KafeParser::T__25 - 24))
      | (1ULL << (KafeParser::T__38 - 24))
      | (1ULL << (KafeParser::T__45 - 24))
      | (1ULL << (KafeParser::T__49 - 24))
      | (1ULL << (KafeParser::T__63 - 24))
      | (1ULL << (KafeParser::NAME - 24))
      | (1ULL << (KafeParser::NORMALSTRING - 24))
      | (1ULL << (KafeParser::CHARSTRING - 24))
      | (1ULL << (KafeParser::INT - 24))
      | (1ULL << (KafeParser::HEX - 24))
      | (1ULL << (KafeParser::FLOAT - 24))
      | (1ULL << (KafeParser::HEX_FLOAT - 24)))) != 0)) {
      setState(156);
      explist();
      setState(161);
      _errHandler->sync(this);
...
KafeParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x3, 0x9, 0x3, 0x9, 0x5, 0x9, 0x9c, 0xa, 0x9, 0x3, 0x9, 0x3, 0x9, 0x7, 
    ...
    0x3, 0x2, 0x2, 0x2, 0x10, 0x9b, 0x3, 0x2, 0x2, 0x2, 0x12, 0xb3, 0x3, 
    ...
    0x9c, 0x7, 0x44, 0x2, 0x2, 0x9a, 0x9c, 0x5, 0xe, 0x8, 0x2, 0x9b, 0x99, 
    0x3, 0x2, 0x2, 0x2, 0x9b, 0x9a, 0x3, 0x2, 0x2, 0x2, 0x9c, 0x9d, 0x3, 
    0x2, 0x2, 0x2, 0x9d, 0xa1, 0x7, 0x18, 0x2, 0x2, 0x9e, 0xa0, 0x5, 0xc, 
    ...
    0x7a, 0x7e, 0x8a, 0x90, 0x97, 0x9b, 0xa1, 0xb3, 0xd5, 0xd7, 0xdf, 0xe3, 
  };
